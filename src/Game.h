...
private:
 ...
 std::vector<ShapeTile> _shapeTiles = {
        ...
        ShapeTile({{0, 0},{0, 2},{1, 0},{1, 1}, {1, 2}, {3, 1},{4, 0},{4, 1}}),
        ShapeTile({{0, 2},{1, 0},{1, 1},{1, 2}, {3, 1}, {3, 2},{3, 3},{4, 1}}),
        ShapeTile({{0, 1},{0, 2},{1, 1},{2, 1}, {3, 0}, {3, 1},{3, 2}}),
        ShapeTile({{0, 0},{1, 0},{2, 0},{2, 1}, {3, 0}, {4, 0}}),
        ShapeTile({{0, 0},{0, 1},{1, 1},{1, 3}, {2, 0}, {2, 1},{2, 2},{2, 3}}),
        ...
        ShapeTile({{0, 1},{1, 2},{1, 1},{2, 0}, {2, 1}, {3, 1},{3, 2},{4, 0},{5, 0}}),
